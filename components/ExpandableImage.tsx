...
export default function ExpandableImage({
  ...
  // Compute transform to position the image at the thumbnail's location
  const getImageStyle = (): React.CSSProperties => {
    if (!thumbRect) return {};

    if (!animating) {
      // Start position: match the thumbnail exactly
      ...
      // Calculate scale based on thumbnail size vs viewport-fitted size
    ...
    // Animated position: centered and full size
    return {
