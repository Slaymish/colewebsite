...
export default function ContactContent({ settings }: ContactContentProps) {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold tracking-[-0.03em] text-black sm:text-4xl">Contact</h1>

      <div className="space-y-4 text-[1rem] leading-[1.7] text-black/70">
        {settings?.contact_email && (
          <div className="flex flex-col gap-1">
            <span className="text-[0.75rem] tracking-wider text-black/40 uppercase">Email</span>
            <a
        ...
        {settings?.contact_phone && (
          <div className="flex flex-col gap-1">
            <span className="text-[0.75rem] tracking-wider text-black/40 uppercase">Phone</span>
            <a
      ...
      {socialLinks.length > 0 && (
        <div className="pt-8">
          <span className="mb-4 block text-[0.75rem] tracking-wider text-black/40 uppercase">
            Socials
          </span>
