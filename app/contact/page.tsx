...
export default async function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <nav className="flex items-center justify-between border-b border-black/8 px-6 py-5 sm:px-10 md:px-14">
        <Link href="/" className="text-[0.85rem] text-black/50 transition hover:text-black/80">
          ← {name}
        </Link>
        {cvUrl && (
          <a
